...
public class VertexMatcherTest {
    ...
    @Test
    public void testGetMatchingTo_isolatedVertices_success() {
        //given
        final VertexMatcher matcher = new VertexMatcher(Arrays.asList(
    ...
    @Test
    public void testGetMatchingTo_oneEdge_success() {
        //given
        final VertexMatcher matcher = new VertexMatcher(Arrays.asList(
                new VertexMatchRequirement(0, Collections.emptyList()),
                new VertexMatchRequirement(1,
                        Collections.singletonList(new Edge(0, 1)))
        ));
        final Graph dstGraph = new Graph();
        dstGraph.setVerticesCount(2);
        dstGraph.setEdges(
                Collections.singletonList(new Edge(1, 0))
        );
        //when
        final Optional<VertexMatching> matching = matcher.getMatchingTo(dstGraph);
        //then
    ...
    @Test
    public void testGetMatchingTo_twoEdges_sameDirection_success() {
        //given
        final VertexMatcher matcher = new VertexMatcher(Arrays.asList(
                new VertexMatchRequirement(0, Collections.emptyList()),
                new VertexMatchRequirement(1, Collections.emptyList()),
                new VertexMatchRequirement(2,
                        Arrays.asList(new Edge(2, 0), new Edge(2, 1)))
        ));
        final Graph dstGraph = new Graph();
    ...
    @Test
    public void testGetMatchingTo_twoEdges_badDirection_failure() {
        //given
        final VertexMatcher matcher = new VertexMatcher(Arrays.asList(
                new VertexMatchRequirement(0, Collections.emptyList()),
                new VertexMatchRequirement(1, Collections.emptyList()),
