...
public class VertexMatchRequirementsFactoryTest {
	...
	@Test
	public void testGetRequirementsFor_edgeAssignedToVertexWithHigherPreOrder() throws Exception {
		//given
		...
		graph.setEdges(Lists.newArrayList(new Edge(0, 1), new Edge(0, 2), new Edge(1, 2)));
		//when
		...
		assertRequirement(requirements.get(1), 0, Collections.singletonList(new Edge(0, 2)));
		assertRequirement(requirements.get(2), 1, Lists.newArrayList(new Edge(0, 1), new Edge(1, 2)));
	}
}